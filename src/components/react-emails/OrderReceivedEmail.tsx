...
const OrderReceivedEmail = ({
  ...
  const baseUrl =
    process.env.NODE_ENV === "development"
      ? "http://localhost:3000"
      : "https://case-cobra-teal.vercel.app";
  return (
    <Html>
      <Head />
        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              We're preparing everything for delivery and will notify you when
              you order has shipped.
            </Text>
            <Text style={{ ...global.text, marginTop: 24 }}>
              If you have questions about your order. Please contact us with
              your order number.
            </Text>
          </Section>
          <Hr style={global.hr} />
          ...
          <Section style={paddingY}>
            <Row>
              ...
              >
                Please contact us if you have any questions. (This is a
                auto-generated email that does not reply.)
              </Text>
            </Row>
            <Row>
              <Text style={footer.text}>
                &copy; CaseCobra, LLC. All Right Reserved.
              </Text>
            </Row>
          </Section>
        </Container>
